          ...
          <Modal centered size="xl" show={videoModal} onHide={videoClose}>
            <Modal.Body className="Section-1 rounded-lg">
              <div className="mb-5 text-right">
                <button type="button" onClick={videoClose} className="btn p-0">
                  <i className="fa fa-times"></i>
                </button>
              </div>
              <div className="col-lg-8 px-0 mx-auto">
                <h1 className="display-4 font-weight-bolder mb-8 text-center">
                  WELCOME TO YOU EMBARKING ON YOUR LEARNING JOURNEY
                </h1>
                ...
                <div className="my-8 text-center">
                  <button
                    type="button"
                    className="btn btn-primary text-uppercase py-4 font-weight-boldest h5 mb-0 col col-md-4"
                  >
                    START NOW
                  </button>
                </div>
