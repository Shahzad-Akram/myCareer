...
export const HomePage = () => {
  ...
  return (
    <>
          ...
          <div className="row mx-0 align-items-center py-3">
            ...
            <div className="d-none d-lg-block">
              <ul className="nav">
                <li className="nav-item mx-3">
                  <a
                    className="text-body text-hover-primary font-weight-bold"
                    href="#Section-2"
                  >
                    Why CareeFit Design{" "}
                  </a>
            ...
            <div className="d-flex align-items-baseline ml-auto">
              <div>
                <Link
                  to="/auth/login"
                  className="text-capitalize text-warning text-hover-white bg-hover-warning border border-warning h-35px d-flex align-items-center px-7 h5 mb-0 mx-1"
                >
                  Login
                </Link>
              ...
              <Link
                to="/dashboard2"
                className="text-capitalize text-white text-hover-white bg-warning border border-warning h-35px d-flex align-items-center px-7 h5 mb-0 mx-1"
              >
                Get Start Free
              </Link>
            </div>
      ...
      <section
        id="Section-1"
        className="Section-1 pt-md-48 mt-xl-20 pt-30 pb-30"
      >
            ...
            <form>
              <div className="row row-cols-1 row-cols-md-3 col-lg-10 mx-auto">
                <div className="col my-3 my-md-0">
                  <div>
                    <input
                      className="form-control form-control-lg py-8"
                      type="email"
                      placeholder="Email*"
                    />
                  </div>
                ...
                <div className="col my-3 my-md-0">
                  <div className="h-100">
                    <input
                      className="btn btn-block btn-primary py-4 h4 mb-0 font-weight-bolder"
                      type="submit"
                      value="Sign up"
                    />
                    <div className="mt-4">
                      <label class="checkbox d-flex align-items-baseline flex-shrink-0 m-0">
                        ...
                        <span></span>
                        <label className="text-white ml-4" htmlFor="check">
          ...
          <div className="text-center mb-20">
            <div className="mb-4 row mx-0 align-items-baseline justify-content-center">
              ...
              <img
                src={Logo}
                alt="logo"
                className="order-first order-md-last mb-5 mb-md-0"
              />
            </div>
            <h5 className="text-primary">
              From Across Different Fields With a Strong HR / Training / Talent
          ...
          <Row className="justify-content-between">
            <Col md={6} lg={7}>
              ...
              <p className="font-size-h6 text-black-50">
                The CareerFit DESIGN digital learning and development platform
                is co-created by:
              </p>
              ...
              <div className="text-black-50">
                <p className="mb-7">
                  Specialized in digital transformation consultation and backed
                  by a strong network of top-notched professionals from
                  different technology arenas such as web technologies, cloud
                  computing, AI, big data & analytics etc. To accelerate the
                  digital transformation momentum in the business world, Champ
                  Genesis Limited has worked hand in hand with corporates from
                  across various industries to digitalize their business models
                  so as to empower them to drive a more sustainable business
                  growth in the digital era.
                </p>
                <p className="mb-7">
                  Through our interactive CareerFit DESIGN digital learning and
                  development platform, Champ Genesis Limited has adopted
                  breakthrough digital innovations and played a pivotal role in
                  the digitalization of a successful learning and development
                  program designed by I Can Fly Limited, thereby creating a more
                  scalable business model in the digital space.
                </p>
                ...
                <p className="mb-7 ">
                  <span className="font-weight-bolder text-capitalize h6">
                    I Can Fly Development Limited
                  </span>{" "}
                  (Accredited Social Enterprise with SEE Mark) Expertise in
                  Learning & Development (L&D) to empower youth in career
                  planning and business executives of corporations in
                  strengthening their communication & leadership skills.
                </p>
                <p className="mb-7">
                  Since 2015, “I Can Fly” has been providing practical workshops
                  to DSE students on admissions interview skills for
                  Universities and Institutes of Higher Education, with over 90%
                  rating for these workshops, including some positive feedback
                  about the program which has not only sharpened their interview
                  skills, but also boosted their self-confidence level.
                </p>
                ...
                <p className="mb-7">
                  Should you have any enquiries, please contact us by filling in
                  the form. Thank you
                </p>
              </div>
            </Col>
