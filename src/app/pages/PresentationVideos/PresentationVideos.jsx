...
export const PresentationVideos = () => {
  ...
  function getStepContent(stepIndex) {
    switch (stepIndex) {
      ...
      case 2:
        return <PresentationVideosStep3 />;
      case 3:
        return (
          <PresentationVideosStep1
            title='Shape your presentation skill with professional trainers'
          ...
          <div>
            ...
            <Modal.Body className='Section-1 rounded-lg'>
              ...
              <div className='col-lg-8 px-0 mx-auto'>
                 <h1 className='display-4 font-weight-bolder mb-8 text-center text-uppercase'>Want to Continue YOUR LEARNING JOURNEY?</h1>
            
              <div className='mb-8 text-center'>
                <button type='button' className='btn btn-primary text-capitalize py-4 font-weight-boldest h5 mb-0 col col-md-4'>Upgrade Now</button>
              </div>
              </div>
              </Modal.Body>
              </Modal>
                  ...
                  <div className='col col-md-6'>
                    <div class='p-5'>
                      ...
                      <div class='mb-4 font-weight-bold'>
                        ...
                        opened up new realities about the nature of our universe
                        in this clip from Season 8
                      </div>
                      <p class='mb-4 text-black-50'>
                        Lorem ipsum, dolor sit amet consectetur adipisicing
                        elit. Beatae numquam cumque, quam eum distinctio iste
                        illo dolorum exercitationem porro eligendi provident in
                        magni voluptate alias. Porro nulla iste exercitationem
                        repudiandae.
                      </p>
                      <p class='mb-4 text-black-50'>
                        Lorem ipsum, dolor sit amet consectetur adipisicing
